      ...
      >
          ...
          {visibleCount < navItems.length && (
            <div
              ...
              onMouseLeave={() => {
                ...
                closeTimeoutRef.current = setTimeout(() => setHoveredMoreItem(null), 150);
              }}
            >
              <button
                      ...
                      {navItems.slice(visibleCount).map((item) => (
                        <div
                          ...
                          onMouseEnter={(e) => {
                            ...
                            setSubmenuPosition(
                              spaceRight < submenuWidth && spaceLeft > submenuWidth ? "left" : "right"
                            );
                          }}
                          onMouseLeave={() => {
                            closeTimeoutRef.current = setTimeout(() => setHoveredMoreItem(null), 150);
                        ...
                        >
                          ...
                          {/* Submenu Portal */}
                          {(item.headings?.length || item.subItems?.length) > 0 && (
                            <SubmenuPortal
        ...
        {isMobileMenuOpen && (
          <div
            ...
            style={{ borderTopColor: "var(--border-top)", height: "calc(100vh - 64px - 40px)" }}
          >
            ...
            {/* Mobile Modules */}
            <div className="overflow-y-auto max-h-[calc(100vh-64px-38px)] px-4 py-4 space-y-4"
                onWheel={(e) => {
